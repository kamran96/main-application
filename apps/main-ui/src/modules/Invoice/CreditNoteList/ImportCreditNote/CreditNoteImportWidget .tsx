...
import { InvoiceImportManager } from '../../InvoiceImportManager';
import { getCreditNotesKeysApi } from '../../../../api';
...
const CreditNoteImportWidget: FC = () => {
  const { creditNote, setCreditNote } = useGlobalContext();
  const { visibility } = creditNote;
...
export default CreditNoteImportWidget;
