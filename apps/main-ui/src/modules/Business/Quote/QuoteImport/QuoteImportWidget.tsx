...
const QuoteImportWidget: FC = () => {
  const { quotes, setQuotes } = useGlobalContext();
  const { visibility } = quotes;
...
export default QuoteImportWidget;
