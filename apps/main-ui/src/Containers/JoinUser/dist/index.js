    ...
    react_1['default'].createElement(
      ...
      react_1['default'].createElement(
        ...
        react_1['default'].createElement(
          ...
          react_1['default'].createElement(
            'div',
            { className: 'responsibilities mt-20' },
            react_1['default'].createElement(
              'h2',
              { className: 'title' },
              'Wellcome to Organization'
            ),
            react_1['default'].createElement(
              'h4',
    ...
    react_1['default'].createElement(
      ...
      react_1['default'].createElement(
        ...
        react_1['default'].createElement(
          ...
          react_1['default'].createElement(antd_1.Input.Password, {
            size: 'large',
          })
        ),
        react_1['default'].createElement(
          antd_1.Form.Item,
          { name: 'agreed', valuePropName: 'checked' },
          react_1['default'].createElement(
            antd_1.Checkbox,
            null,
            react_1['default'].createElement(
        ...
        react_1['default'].createElement(
          antd_1.Form.Item,
          { name: 'update-details', valuePropName: 'checked' },
          react_1['default'].createElement(
            antd_1.Checkbox,
            null,
...
var WrapperJoinUser = styled_components_1['default'].div(
  templateObject_1 ||
