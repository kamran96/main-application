...
export class alterTablesName1600073436152 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "KeyStorages" RENAME TO "key_storages"'
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "invoices" RENAME TO "Invoices"');
    await queryRunner.query(
      'ALTER TABLE "invoice_items" RENAME TO "InvoiceItems"'
    );
    await queryRunner.query(
      'ALTER TABLE "key_storages" RENAME TO "KeyStorages"'
    );
    await queryRunner.query(
      'ALTER TABLE "organizations" RENAME TO "Organizations"'
    );
    ...
    await queryRunner.query(
      'ALTER TABLE "role_permissions" RENAME TO "RolePermissions"'
    );
    await queryRunner.query(
